...
if(isset($_POST["submit"])){
    ...
    $result = mysqli_query($conn, "SELECT * FROM doctors WHERE doctor_email='$usernameemail'");
    $row = mysqli_fetch_assoc($result);
    if(mysqli_num_rows($result)>0){
        if($password == $row["doctor_pasword"]){
        $_SESSION["login"] = true;
        $_SESSION["id"] = $row["id"];        
...
<header>
    ...
    <div class="login_bg">
        ...
        <div style="width: 100px; height: 100px; background-color: rgb(141, 183, 199); border-radius: 0px 0px 100px 100px;text-align: center;"> <i class="fa-solid fa-user-doctor" style="font-size: 60px; color:rgb(211, 211, 211);"></i></div>
            <h1>Welcome back Doctor</h1>
            <p class="welcome_des"> Doctor Please enter your details to Login</p>
            <br>
